...
$menusor=$conn->prepare("SELECT * FROM menu where menu_id=:id");
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="../baglanti/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <input type="" id="first-name" name="menu_link" disabled="" value="<?php echo $ayarcek['ayar_url'] ?>/sayfa-<?php echo seo($menucek['menu_ad']) ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <textarea  class="ckeditor" id="editor1" value="<?php echo $menucek['menu_detay'] ?>" name="menu_detay"></textarea>
                </div>
              </div>
